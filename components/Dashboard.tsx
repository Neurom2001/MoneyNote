...
import { LogOut, Plus, Trash2, Home, Download, Loader2, ArrowUpDown, ArrowUp, ArrowDown, X, Edit, Save, CheckCircle2, AlertCircle } from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({ currentUser, onLogout }) => {
  ...
  const handleRowClick = (t: Transaction) => {
    ...
    setShowDeleteConfirm(false); // Reset delete state when opening new row
  };
                 ...
                 <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-4 space-y-4 animate-in fade-in slide-in-from-bottom-2">
                     ...
                     <div className="flex gap-3">
                         <button 
                            ...
                            className="flex-1 py-2 rounded-lg bg-slate-700 text-white hover:bg-slate-600 font-bold text-sm transition"
                         >
                             မဖျက်တော့ပါ
                         </button>
                         <button 
                            onClick={confirmDelete}
                            className="flex-1 py-2 rounded-lg bg-red-600 text-white hover:bg-red-700 font-bold text-sm transition shadow-lg shadow-red-900/20"
                         >
                             ဖျက်မည်
                         </button>
                     </div>
